# Generated by Django 3.1.2 on 2021-03-06 14:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('year', models.IntegerField(choices=[(2008, 2008), (2009, 2009), (2010, 2010), (2011, 2011), (2012, 2012), (2013, 2013), (2014, 2014), (2015, 2015), (2016, 2016), (2017, 2017), (2018, 2018), (2019, 2019), (2020, 2020), (2021, 2021)], default=2021, verbose_name='Year')),
                ('month', models.CharField(choices=[('January', 'January'), ('February', 'February'), ('March', 'March'), ('April', 'April'), ('May', 'May'), ('June', 'June'), ('July', 'July'), ('August', 'August'), ('September', 'September'), ('October', 'October'), ('November', 'November'), ('December', 'December')], default='January', max_length=150, verbose_name='Month')),
                ('total_Books', models.PositiveIntegerField(default=0, verbose_name='Total Number of Books')),
                ('books_Added_This_Month', models.PositiveIntegerField(default=0, verbose_name='Number of Books added This Month')),
                ('new_Books_Cost', models.PositiveIntegerField(default=0, verbose_name='Cost spent on new books This Month (Rs.)')),
                ('number_of_Volumes', models.PositiveIntegerField(default=0, verbose_name='Number of Volumes')),
                ('number_of_International_Journals', models.PositiveIntegerField(default=0, verbose_name='Number of International Journals')),
                ('number_of_National_Journals', models.PositiveIntegerField(default=0, verbose_name='Number of National Journals')),
                ('current_Periodicals', models.PositiveIntegerField(default=0, verbose_name='Current Periodicals')),
                ('thesis_and_Dissertations', models.PositiveIntegerField(default=0, verbose_name='Thesis & Dissertations')),
                ('video_Recordings_open_NPTEL_or_DMS_close', models.PositiveIntegerField(default=0, verbose_name='Video Recordings (NPTEL/DMS)')),
            ],
        ),
        migrations.CreateModel(
            name='Library2',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('students_Placed_Percentage', models.PositiveIntegerField(verbose_name='Percentage of students placed')),
